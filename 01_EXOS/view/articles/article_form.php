...
<form action="<?php echo $datas['formUrl']; ?>" method="post">
    ...
    <label for="ContentArticle">
        ...
        <textarea id="ContentArticle" name="ContentArticle" placeholder="Contenu principal de l'article"><?php echo ( isset( $data['ContentArticle'] ) ) ? 
        $data['ContentArticle'] : ''; ?></textarea>
    </label>
